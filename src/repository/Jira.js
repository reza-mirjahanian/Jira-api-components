...
module.exports = class Jira {
   ...
   * @return {Promise<Array>} List of components that don't have a "component lead".
   */
   ...
   *  @return {Promise<Array>} List of components that don't have a "component lead", along with the number of issues.
   */
